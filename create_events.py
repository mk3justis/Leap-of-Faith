...
def generate_events():
    ...
    Parental_Visit = Event("Parental Visit - Your parents called this week. They’re coming up to visit you this weekend. While your parents coming up is nice, you were hoping that this weekend, you could take a break and work on a little personal project you started this summer, since you don’t really have a lot of work this weekend. This opportunity may never come up again. Do you ask your parents if they can reschedule?\n")
    Parental_Visit.yes(2, 0, -1, 1)
    Parental_Visit.no(-1, 0, 2, 0)
    eventList.append(Parental_Visit)

    Game_Night_with_the_Boys = Event("Game Night with the Boys - Every week, you and your friends get together and play Crag Cats 3. Your role in your party is quite vital. However, this week, you have an absolute TON of homework. Your professors were not merciful this week. You’re sure that you could get it all done this weekend, but it’ll be quite the crunch. Do you do skip this week?\n")
    Game_Night_with_the_Boys.yes(0, 1, -1, 0)
    Game_Night_with_the_Boys.no(0, -2, 2, 0)
    ...
    Annoying_Friend = Event("Annoying Friend - Your friend invites you to come to lunch with him and his family this weekend, since he’s a local. It’ll be nice and dandy, but your friend can be a little annoying, especially when it comes to conversation, and a meal involves a LOT of conversation. Do you go to lunch with them?\n")
    Annoying_Friend.yes(0, 0, 2, -1)
    Annoying_Friend.no(0, 0, -1, 2)
    eventList.append(Annoying_Friend)

    Faith_Crisis = Event("Faith Crisis - It’s the weekend. That means that it’s time to go to Faith Services. You like Services. The faith Speaker is a good speaker and has taught you many good life lessons. Plus, it’s nice to go with your little group of friends. However, lately, you’ve been having some issues with the order. Last week’s service, the Speaker went on a rant about something that you really didn’t agree with. This weekend, your friend invites you to come to services again. Do you go?\n")
    ...
    Hiding = Event("Hiding  - You are very tired from classes this week. Your last class ends at 4 today. Usually, after your final class, you meet your friend at the cafeteria and get dinner. But you are just so very tired and burnt out. You do not have the mental capacity to maintain a conversation right now. There is a corner in the cafeteria, where you can just eat alone. Do you eat with your friend today?\n")
    Hiding.yes(0, 0, 1, -1)
    Hiding.no(0, 0, -1, 1)
    eventList.append(Hiding)

    TV_Break = Event("TV Break - It’s Friday. It’s been a hard week. You’ve just got back from dinner and you figure you could watch some TV. You have all weekend to do work. You’re sure goofing off tonight will be okay. Do you do watch TV?\n")
    ...
    Home_Game_Night = Event("Home Game Night - One of your roommates decides that you all should have a game night tonight. All of you will get together and play Party Box Central 7. It sounds quite fun, and it’s been some time since you’ve hung out recreationally with your roommates. But alas, you have lots of work this week. Do you join in on the game night?\n")
    Home_Game_Night.yes(0, -1, 2, 0)
    Home_Game_Night.no(0, 1, 0, 0)
    eventList.append(Home_Game_Night)

    Listening_to_Music = Event("Listening to Music - Work is hard. Really hard. But one of the upsides is that you get to listen to music while you do it. You’re singing along and getting in good with the vibes when you realize all this fun is distracting you from your work. You’re sure you can get it done in time, but it may take longer, delaying you from getting more work done. Do you turn off the music?\n")
    Listening_to_Music.yes(0, 1, 0, -1)
    Listening_to_Music.no(0, -2, 0, 1)
    eventList.append(Listening_to_Music)

    Code_Family = Event("Code Family - Your programming professor assigned a project that they’re allowing to be done in groups. Group work is fine and all, but you’ve had some bad experiences with group projects in the past. Plus, in order to share code, you all would have to use Code Family, which is a very difficult app to use and deal with. But it’ll get done faster. Is it worth working in a group?\n")
    Code_Family.yes(1, 0, 1, -1)
    Code_Family.no(0, 0, -1, 0)
    eventList.append(Code_Family)

    Group_Project = Event("Group Project - Your professor has assigned a project that they’re allowing to be done in groups. You’ve had some bad experiences working in groups before. You always have to get everyone to work together and make sure that everyone does their part. Exhausting. But it’ll get done faster and likely better. Is it worth working in groups?\n")
